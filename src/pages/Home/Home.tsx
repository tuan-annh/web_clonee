        ...
        <div className='col-span-2 '>
          ...
          <div className='flex h-1/2 flex-col justify-center bg-client-say py-16 text-center'>
            ...
            <p className='mx-14 py-10 text-center'>
              ...
              asperiores obcaecati facere distinctio omnis ullam libero repudiandae officia! Accusamus numquam, sed
              minus distinctio quaerat tempore sint possimus animi? Lorem ipsum dolor sit amet consectetur,
            </p>
          ...
          <div className='grid grid-cols-3 px-7 pt-10'>
            <div className='my-5 flex-col items-center text-center'>
              ...
              <p className='my-5 font-bold'>Free Worldwide Shipping</p>
            ...
            <div className='my-5 flex-col items-center text-center'>
              ...
              <p className='my-5 font-bold'>100% Payment Secure</p>
