...
<<<<<<< HEAD
  ...
  //   const { isAuthenticated, setisAuthenticated } = useContext(AppContext)
  return (
    <header className='bg-white-800 text-black border-b h-24 ư-screen'>
      <div className='container grid grid-cols-8 items-center mx-auto px-7 py-6 z-10 bg-white w-full'>
=======
